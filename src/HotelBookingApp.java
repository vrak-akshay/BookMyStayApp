...
class BookingHistory{
    ...
    public synchronized ConfirmedReservation find(String id){
    ...
    public void processReservation(Reservation r){
        try{
            ...
            if(inventory.allocateRoom(type)){
                ...
                System.out.println(Thread.currentThread().getName()+" confirmed "+roomId+" "+r.getGuestName());
            }else{
...
public class HotelBookingApp{
    public static void main(String[] args) throws InterruptedException{
        ...
        ConcurrentBookingProcessor t1=new ConcurrentBookingProcessor(queue,service);
        ConcurrentBookingProcessor t2=new ConcurrentBookingProcessor(queue,service);
        ConcurrentBookingProcessor t3=new ConcurrentBookingProcessor(queue,service);
